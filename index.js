...
const getTerminalDetails = () => {
    ...
    fetch('https://dev-api.devptest.com/api/TerminalDetails/GetTerminalDetails', {
        method: 'get',
        headers: {
...
const postDataToCoffeeWeb = (robustaArray, arabicaArray) => {
    ...
    console.log(data)
    fetch('https://dev-api.devptest.com/api/TincapheAuth/InsertTincapheData', {
        method: 'POST',
        headers: {
            Authorization: `Bearer ${localAuthToken}`,
            accept: "application/json",
...
const postXECurrencyData = (xeArray) => {
    fetch('https://dev-api.devptest.com/api/CoffeeQuotesCurrency/PostcoffeequotesCurrency', {
        method: 'POST',
        headers: {
            Authorization: `Bearer ${localAuthToken}`,
            accept: "application/json",
