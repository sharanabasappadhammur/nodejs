            ...
            for (let i = 0; i < rowIds.length; i++) {
                ...
                if (i <= 4) {
                    const object = {
                        ...
                        prevRate: ((hour === 1 && minute >= 30) || (hour === 2 && minute <= 35)) ? typeof targetedObject.vs[9] == "string" ? parseInt(targetedObject.vs[9].replace(",", "")) : targetedObject.vs[9] : parseInt(targetedObject.vs[1]) - targetedObject.vs[2],
